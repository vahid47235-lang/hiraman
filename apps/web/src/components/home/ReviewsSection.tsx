          ...
          <div className={cn('flex items-end justify-between gap-8', isFa && 'flex-row-reverse')}>
            ...
            <div className={cn('flex items-center gap-2 text-lootka-pine', isFa && 'flex-row-reverse')}>
              ...
              <div>
                ...
                <div className="text-caption text-white/55 mt-0.5">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {reviews.map((review) => (
            ...
            >
              ...
              {/* Review text */}
              <p className="text-body text-white leading-relaxed mb-5 line-clamp-3" itemProp="reviewBody">
                "{review.text}"
              </p>

              {/* Meta */}
              <div className={cn('flex items-center gap-3 border-t border-white/10 pt-4', isFa && 'flex-row-reverse')}>
                {review.avatarUrl && (
                  <Image
                ...
                <div className="flex-1">
                  <div className="text-body-sm font-medium text-white" itemProp="author">
                    {review.author}
                  </div>
                  <div className="text-caption text-white/55 mt-0.5">{review.location}</div>
                </div>
                <div className="text-caption text-white/55/60 num" dir="ltr">
                  {review.date}
                </div>
              </div>
